	...
	//---music---//
		var music = [
			...
			["penduluminous","penduluminous.png","Penduluminous",[
				["After All","afterall.m4a"],
				["Would You Be My Muse?","wouldyoubemymuse.m4a"],
				["Ghost in the Drum Machine","ghostinthedrummachine.m4a"],
				["Where We Left Off","whereweleftoff.m4a"],
				["Flash (Hurry Up and Wait)","flashhurryupandwait.m4a"],
				["You Told Me That You Loved Me Too Soon","youtoldmethatyoulovedmetoosoon.m4a"],
				["Treasure","treasure.m4a"],
				["Moonlight","moonlinght.m4a"],
				["Wheels Turning","wheelsturning.m4a"],
				["Sorry I'm So Late","sorryimsolate.m4a"],
				["Tell Me","tellme.m4a"],
				["Rise","rise.m4a"],
				["Swing, Pendulum, Swing","swingpendulumswing.m4a"],
				["One Day","oneday.m4a"],
				["Minus Money","minusmoney.m4a"],
				["365","365.m4a"],
			]],
			["thedeathmakerssymphony","thedeathmakerssymphony.png","The Deathmakers' Symphony",[
				["Adaptation","adaptation.m4a"],
				["Shipwreck","shipwreck.m4a"],
				["A Most Peculiar Child","amostpeculiarchild.m4a"],
				["Becoming Friends","becomingfriends.m4a"],
				["Jailbreak!","jailbreak.m4a"],
				["The Dragon","thedragon.m4a"],
				["Never Been Home Before","neverbeenhomebefore.m4a"],
				["Maybe Something More","maybesomethingmore.m4a"],
				["Construction","construction.m4a"],
				["Bittersweet","bittersweet.m4a"],
				["Sails on the Horizon","sailsonthehorizon.m4a"],
				["Annihilation","annihilation.m4a"],
				["The Lightning Isle","thelightningisle.m4a"],
				["Lovelost","lovelost.m4a"],
				["The Cure","thecure.m4a"],
				["Forever","forever.m4a"],
			]],
